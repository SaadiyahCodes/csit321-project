    ...
    <>
      ...
      <div dir="ltr" style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", minHeight: 0 }}>
          <div className="bs-layout" style={{ display: "flex", flexWrap: "wrap", padding: "8px 0 16px" }}>
            ...
            <div className="bs-detail-col" style={{ flex: 1, minWidth: 0, padding: "0 24px" }}>
              ...
              {(item.category || item.ingredients || item.allergens) && (
                <div style={{
              ...
              {isAvailable && (
                <div style={{ marginBottom: 8, width: "100%", boxSizing: "border-box" }}>
          ...
          {isAvailable ? (
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, flexWrap: "wrap" }}>
              <div style={{
                ...
                background: "#fff7ed", borderRadius: 999, padding: "5px 8px",
              }}>
                ...
                <span style={{ fontWeight: 800, fontSize: 16, color: "#111", minWidth: 18, textAlign: "center" }}>{qty}</span>
              ...
              <button onClick={handleAdd} disabled={adding} style={{
                ...
                {adding ? <TranslatedText>Adding…</TranslatedText> : (
                  <>
                    ...
                    {totalPrice && <span style={{ opacity: 0.85, fontSize: 13 }}>· {totalPrice} AED</span>}
                  </>
                )}
              </button>
            </div>
