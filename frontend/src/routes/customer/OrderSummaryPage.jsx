...
export default function OrderSummaryPage() {
  ...
  const finalizeOrder = async () => {
    ...
    try {
      ...
      alert(err.response?.data?.detail || "Failed to finalize order");
  ...
  if (!orderData) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <p className="font-semibold text-red-600">Failed to load order</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-12 px-4 text-center">
        ...
        <p className="text-orange-100">Show this QR code to the waiter</p>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 -mt-8">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8 mb-6">
          <h2 className="text-center font-bold text-lg mb-4">Scan to Confirm Order</h2>
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6 mb-6">
          <h3 className="font-extrabold text-lg mb-4">Order Summary</h3>
